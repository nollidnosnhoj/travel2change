    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_photo', models.ImageField(blank=True, help_text='This photo will be featured on listings and the topof your activity page.', null=True, upload_to='', verbose_name='featured photo')),
